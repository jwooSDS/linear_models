...
Please see the video below for more explanation on how to use Figure \@ref(fig:ass1) to assess assumption 1. 

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Checking Assumption 1 using Scatterplot" src="https://virginiauniversity.instructuremedia.com/embed/db4864f2-d44a-4904-9749-64f1c6847f4e" frameborder="0"></iframe>
...
Please see the video below for more explanation on how to use Figure \@ref(fig:ass2) to assess assumption 2.

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Checking Assumption 2 using Scatterplot" src="https://virginiauniversity.instructuremedia.com/embed/54a1f8fe-8d51-49d8-b172-057d7b4f4095" frameborder="0"></iframe>
...
Please see the video below for more explanation on how to use Figure \@ref(fig:resplots) to assess assumptions 1 and 2. 

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Checking Assumptions using Residual Plot" src="https://virginiauniversity.instructuremedia.com/embed/d17b080c-4ac7-47c3-855f-3fe36ba5ef74" frameborder="0"></iframe>
...
Please see the video below as I go over these practice questions.

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Section 3.2.1 Practice Questions" src="https://virginiauniversity.instructuremedia.com/embed/d5c3a136-3f19-43e5-ae5c-508ed51c3e53" frameborder="0"></iframe>
...
Please see the video below as I go over the math explaining how we interpret regression coefficients when the response variable is log transformed.

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Coeff Interpretation with Log Transformed Y" src="https://virginiauniversity.instructuremedia.com/embed/94a5235d-47e5-4f5d-b7ab-08477bca24e8" frameborder="0"></iframe>
...
Please see the video below as I go over the math explaining how we interpret regression coefficients when the predictor variable is log transformed.

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Coeff Interpretation with Log Transformed X" src="https://virginiauniversity.instructuremedia.com/embed/7f9f9b27-3db3-449a-81cb-4bbad7bc4cdb" frameborder="0"></iframe>
...
Please see the video below as I go over the math explaining how we interpret regression coefficients when the both response and predictor variables are log transformed.

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Coeff Interpretation with Log Transformed X & Y" src="https://virginiauniversity.instructuremedia.com/embed/5c00a8f5-3dc1-4a83-a171-f0908263c57b" frameborder="0"></iframe>
...
Please view the video below for a demonstration of this example.

<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Assumptions Tutorial 1" src="https://virginiauniversity.instructuremedia.com/embed/13c7b650-1545-43c9-8f6c-7f0dac796478" frameborder="0"></iframe>
...
<iframe width="560px" height="320px" allowfullscreen="true" allow="autoplay *" title="STAT 6021: Assumptions Tutorial 2" src="https://virginiauniversity.instructuremedia.com/embed/26732ca2-59b4-44e0-96c6-3674795f149d" frameborder="0"></iframe>
